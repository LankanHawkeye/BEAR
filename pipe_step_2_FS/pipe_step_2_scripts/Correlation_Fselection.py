...
print("Correlation Feature Selection Started.")
import sys
...
evaluator = ASEvaluation("weka.attributeSelection.CorrelationAttributeEval")
...
#print(reversed)
reversed.to_csv(output_file+ "%s.csv" % "Correlation", sep=',',  index=False)
print("Correlation Feature Selection Complete.")
jvm.stop()
