...
# -*- coding: utf-8 -*-
print("Relief Feature Selection Started.")
import sys
...
evaluator = ASEvaluation("weka.attributeSelection.ReliefFAttributeEval", options=[])
...
#print(reversed)
reversed.to_csv(output_file+ "%s.csv" % "Relief", sep=',',  index=False)
print("Relief Feature Selection Started.")
jvm.stop()
