...
#This file has three commandline arguments
# input file
filepath=sys.argv[1]
...
# making a class label positive
# allowed options are yes or no
join=sys.argv[4]



#filepath="./pipe_step_1_Bootsrapping/input_file/input.csv"
dataset_DP2 = pd.read_csv(filepath)
...
print("Run the next script with the selected file")
print("========================================================================")
