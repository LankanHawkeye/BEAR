...
# -*- coding: utf-8 -*-
print("Information Gain Feature Selection Started.")
import sys
...
#print(reversed)
reversed.to_csv(output_file+ "%s.csv" % "Information_Gain", sep=',',  index=False)
print("Information Gain Feature Selection Complete.")
jvm.stop()
