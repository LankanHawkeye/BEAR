...
evaluator = ASEvaluation("weka.attributeSelection.GainRatioAttributeEval")
...
#print(reversed)
reversed.to_csv(output_file+ "%s.csv" % "Information_Gain_Ratio", sep=',',  index=False)
print("Information Gain Ratio Feature Selection Complete.")
jvm.stop()
