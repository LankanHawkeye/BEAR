...
1. Install following dependencies first.
	...
	Following are the dependencies of M2ROC tool.
	1. javabridge
	2. matplotlob
	3. matplotlib-venn
	4. numpy
...
5. Run the "run_pipeline.sh" bash along with giving input file as the first argument.
   See the example.
	e.g., We have provided you an example data set called "example.iris.data.csv".
...
bash ./run_pipeline.sh input_file/example.iris.data.csv 3
